      ...
      <div className="container">
        <div className="relative flex items-center">
          ...
          <div className="absolute right-0 flex items-center px-4 lg:hidden">
            <button name="hamburger" id="hamburger" type="button">
              <span className="hamburger-line transition duration-500 origin-top-right"></span>
              <span className="hamburger-line transition duration-500"></span>
              <span className="hamburger-line transition duration-500 origin-bottom-right"></span>
            </button>
          </div>

          <nav id="nav-menu" className="hidden absolute top-full right-0 bg-white border rounded-xl shadow-md max-w-[250px] w-full py-3 dark:shadow-none lg:block lg:static lg:max-w-full lg:bg-transparent lg:border-none lg:shadow-none">
              <ul className="block lg:flex lg:justify-end lg:items-center">
                <li className="group py-3 lg:py-0">
                    <a href="#home" className="nav-list-item">Home</a>
                </li>
                <li className="group py-3 lg:py-0">
                    <a href="#skills" className="nav-list-item">Skills</a>
                </li>
                <li className="group py-3 lg:py-0">
                    <a href="#project" className="nav-list-item">Portfolio</a>
                </li>
                <li className="group py-3 lg:py-0">
                    <a href="#education" className="nav-list-item">Education</a>
                </li>
                <li className="group py-3 lg:py-0">
                    <a href="#contact" className="nav-list-item">Contact</a>
                </li>
